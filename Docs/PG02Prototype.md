...
- FUOCO RAPIDO: +50% ATK SPD corrente, 400 → 600 (6 attacchi/s) senza altri modificatori, durata 4 s. CD BASE 10 s avviato alla fine della durata. Non può essere riattivata durante l'effetto. Un BONUS ATK SPD permanente porta 400 → 420; durante FUOCO RAPIDO vale 630, alla scadenza rimane 420.
...
- PASSIVA 2: ogni 15 KILL personali attiva RAGE per 4 s, +30% ATK corrente. Nuovo gruppo di 15: durata rinnovata senza cumulo. BONUS ATK persistenti restano separati e non vengono persi alla scadenza. RAGE non incrementa il danno fisso di FUOCO DI SOPPRESSIONE.
...
## Aggiornamento FUOCO RAPIDO +50% e RAGE 4 s

Aggiornati asset, valore predefinito, durata runtime RAGE e descrizioni GDD/HUB. FUOCO RAPIDO: 400 → 600; con BONUS persistente 420 → 630 → 420. PASSIVA 2: RAGE per 4 s, sempre +30% ATK ogni 15 KILL. Adeguate le aspettative della suite esistente senza eseguirla. Nessun test o build effettuato, come richiesto; i risultati precedenti restano storici. Preservata la modifica PG04 al raggio di PIOGGIA DI GRANATE.
