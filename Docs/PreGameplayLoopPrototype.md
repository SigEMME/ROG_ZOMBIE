...
Passo successivo: prova manuale di mira, inseguimento/collisioni dell'orda e leggibilità uscita, poi integrare EXP/LVL e passive PG01 in blocchi separati, usando solo GDD. Definire il collider definitivo tramite testing e completare la schermata BONUS 3+2 quando gli effetti entrano nello scope.
